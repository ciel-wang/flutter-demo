...
class DeviceinfoFun {
  static late Map<String, dynamic> deviceData;
  static final DeviceInfoPlugin deviceInfoPlugin = DeviceInfoPlugin();
  static Future<Map<String, dynamic>> initDevInfo() async {
    try {
      if (kIsWeb) {
  ...
  static Map<String, dynamic> readIosDeviceInfo(IosDeviceInfo data) {
    return <String, dynamic>{
      ...
      'identifierForVendor': data.identifierForVendor, //唯一标识符
